...
set rc [catch {
  ...
  set_property ip_repo_paths d:/vivado/Mul_CPU_test/Mul_CPU_test.cache/ip [current_project]
  set_property ip_output_repo d:/vivado/Mul_CPU_test/Mul_CPU_test.cache/ip [current_project]
  add_files -quiet D:/vivado/Mul_CPU_test/Mul_CPU_test.runs/synth_1/Main.dcp
