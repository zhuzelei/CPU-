...
module Main(CLK, RST, outside_pc, ins, now_pc);
  ...
  DataSelector_3to1 Select3_1(endReg, instruction[20:16], instruction[15:11], RegDst, fiveChooseData);
  ...
  DataSelector_2to1_sa Select2_1(o_ADR, instruction[10:6] , ALUSrcA, i_ALUData1);
  DataSelector_2to1 Select2_2(o_BDR, extendData, ALUSrcB, i_ALUData2);
  ...
  DataSelector_2to1 Select2_3(ALUResult, DataOut, DBDataSrc, i_ALUM2DR);
  DBDR DBDR(i_ALUM2DR, CLK, InputWriteData1);
  DataSelector_2to1 Select2_4(pc4, InputWriteData1, WrRegData, WriteData);
  PCAddImm PCAddImm(pc4, extendData, pcChoose1);
  DataSelector_4to1 Select4_1(pc4, pcChoose1, ReadData1, pcChoose3, PCSrc, pc);
  ControlUnit ControlUnit(ALUResult,instruction[31:26], CLK, RST, zero, PCWre, InsMemRW, IRWre, WrRegData, RegWre, ALUSrcA, ALUSrcB, DataMemRW, DBDataSrc, ExtSel, RegDst, PCSrc, ALUOp);
endmodule